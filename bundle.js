...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactTimerMixin = __webpack_require__(162);
	...
	var App = React.createClass({
	  ...
	  loadPlayers: function loadPlayers() {
	    ...
	    this.serverRequest = $.getJSON('https://dl.dropboxusercontent.com/s/hqjcdirwmriymwa/fechnaspoints.json?dl=0', function (result) {
	      ...
	      fechnasPoints.players.sort(function (a, b) {
	        return b.score - a.score;
	      });

	      fechnasPoints.players.map(function (player, i) {
	        player.pos = i;
	      });

	      origin.players.map(function (player) {
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      this.state && this.state.players ? React.createElement(Players, { players: this.state.players }) : 'Loading...'
	    );
	  }
	});
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      this.props.players.map(function (player) {
	        return React.createElement(Player, { key: player.name, player: player });
	      })
	    );
	  }
	});
	...
	var Player = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      'div',
	      { className: 'player ' + 'player--' + playerClass, style: { top: pos * 56 } },
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          'span',
	          { className: 'player__info__name' },
	          name
	        ),
	        React.createElement(
	          'span',
	          { className: 'player__info__score' },
	          score
	        )
	      )
	    );
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../css-loader/index.js!./../autoprefixer-loader/index.js?browsers=last 2 versions!./normalize.css", function() {
				var newContent = require("!!./../css-loader/index.js!./../autoprefixer-loader/index.js?browsers=last 2 versions!./normalize.css");
